...
const Dashboard = () => {
  ...
  const realMapLayerRef = useRef(null);
  ...
  <div style={{
    ...
    />
      ...
      <div style={{ position: 'absolute', top: '60px', right: '10px', zIndex: 1001 }}>
        ...
        <div className="side-buttons" style={{ marginTop: '10px' }}>
        <button onClick={() => alert(' Protocolo de Incendio:\nEvitar zonas boscosas, avisar a autoridades, evacuar si es necesario.')} className="risk-button incendio"></button>
        </div>
